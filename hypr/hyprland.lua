...
local waybar_toggle = "pkill -x waybar || waybar"
local rnd_wall = "waypaper --backend 'awww' --random --folder '/home/rvrs/Pictures/Walls'"

-------------------
---- AUTOSTART ----
-------------------
hl.on("hyprland.start", function () 
   hl.exec_cmd("waypaper --backend 'awww' --random --folder '/home/rvrs/Pictures/Walls'")
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("set-sink-volume @DEFAULT_SINK@ +5%"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("set-sink-volume @DEFAULT_SINK@ -5%"),      { locked = true, repeating = true })
